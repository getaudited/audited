...
func (r *tokenR) GetSource() *Source {
	if r == nil {
		return nil
	}
...
func (tokenL) LoadSource(ctx context.Context, e boil.ContextExecutor, singular bool, maybeToken any, mods queries.Applicator) error {
	var slice []*Token
	var object *Token
...
// SetSource of the token to the related item.
