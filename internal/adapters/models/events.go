...
func (r *eventR) GetSource() *Source {
	if r == nil {
		return nil
	}
...
func (eventL) LoadSource(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEvent any, mods queries.Applicator) error {
	var slice []*Event
	var object *Event
...
// SetSource of the event to the related item.
