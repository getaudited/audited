...
var (
	eventAllColumns            = []string{"id", "tenant_id", "version", "actor_id", "actor_type", "actor_name", "actor_metadata", "context_location", "context_user_agent", "metadata", "occurred_at"}
	eventColumnsWithoutDefault = []string{"id", "tenant_id", "version", "actor_id", "actor_type", "context_location"}
...
func (eventL) LoadEventTargets(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEvent interface{}, mods queries.Applicator) error {
	var slice []*Event
	var object *Event
...
func (o *Event) AddEventTargets(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*EventTarget) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.ID, rel.InternalID}
