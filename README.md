...
Run the service (requires external PostgreSQL):

```bash
docker run -p 8080:8080 \
  -e ADT_DATABASE_URL="postgres://user:password@host:5432/dbname?sslmode=disable" \
...
|---|---|---|
| `ADT_DATABASE_URL` | Yes | PostgreSQL DSN |
